...
program
  ...
  .addHelpText(
    ...
    [
      "",
      "Destination first: the tool asks where the backtest PR goes — Primary (the",
      "source repo) or Sandbox (a separate repo you control) — before any token. The",
      "source is only ever read for a Sandbox.",
      "",
